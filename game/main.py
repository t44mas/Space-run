...
from classes import all_sprites, enemy_sprites, boosts_sprites, start_screen, enemy_bullets_sprites, \
...
if screen_state == "game":
    level_one(screen, clock, FPS, screen_width, screen_height, all_sprites, enemy_sprites, boosts_sprites, my_font)
